...
<div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total Departments / Divisions</span>
                <span class="info-box-number text-right">
                  <?php 
    ...
    <div class="col-12 col-sm-6 col-md-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number text-right">
            <?php 
              $upcoming = $conn->query("SELECT * FROM `leave_applications` where date(date_start) > '".date('d-m-Y')."' and status = 1 and user_id = '{$_settings->userdata('id')}' ")->num_rows;
