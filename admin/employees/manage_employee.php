				...
				<div class="row">
					<div class="col-6">
						...
						<div class="form-group">
							...
							<input type="date" name="dob" id="dob" class="form-control rounded-0" value="<?php echo isset($meta['dob']) ? date("d-m-Y",strtotime($meta['dob'])): '' ?>" required>
						</div>
						<div class="form-group">
					...
					<div class="col-6">
						...
						<div class="form-group">
							<label for="dob">Start Working Date</label>
							<input type="date" name="swd" id="swd" class="form-control rounded-0" value="<?php echo isset($meta['swd']) ? date("d-m-Y",strtotime($meta['swd'])): '' ?>" required>
						</div>
						<div class="form-group">
							<label for="department_id">Department / Division</label>
						...
						<div class="form-group">
							...
							<div class="custom-file">
								<input type="hidden" name="avatar" value="<?php echo isset($meta['avatar']) ? $meta['avatar']: '' ?>" enctype="multipart/form-data">
							<input type="file" class="custom-file-input rounded-circle" id="customFile" name="img" onchange="displayImg(this,$(this))" >
							<label class="custom-file-label" for="customFile">Choose file</label>
							</div>
						</div>
						<div class="form-group d-flex justify-content-center">
							<img src="<?php echo validate_image(isset($meta['avatar']) ? $meta['avatar'] :'') ?>" alt="user_avatar" id="cimg" class="img-fluid img-thumbnail">
						</div>
					</div>
				</div>
			</form>
