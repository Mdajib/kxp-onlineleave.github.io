				...
				<tbody>
					...
					?>
						<tr title="<?php echo $row['description'] ?>">
							...
							<td style="width: 42%;"><p class="truncate m-0" ><?php echo $row['description'] ?></p></td>
							...
							<td><?php echo ($row['date_updated'] != null) ? date('d-m-Y',strtotime($row['date_updated'])) : date('d-m-Y',strtotime($row['date_created'])); ?></td>
							<td align="center">
