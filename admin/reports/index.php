...
<?php endif;?>
<?php 
$date_start = isset($_GET['date_start']) ? $_GET['date_start'] : date("d-m-Y",strtotime(date('d-m-Y').' -3 days'));
        ...
        <div class="row">
            <div class="col-4">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="date_start" value="<?php echo date("d-m-Y",strtotime($date_start)) ?>">
                </div>
            </div>
            <div class="col-4">
            <div class="form-group">
                    <label for="date_end" class="control-label">Date End</label>
                    <input type="date" class="form-control" id="date_end" value="<?php echo date("d-m-Y",strtotime($date_end)) ?>">
                </div>
            </div>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
                                <?php
                                $sql = "SELECT type FROM leave_applications";
                                $type = $row['type'];
